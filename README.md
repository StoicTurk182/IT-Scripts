...
Create repository named IT-Scripts
Do not initialize with README (files already exist locally)
...
The script file - The actual .ps1 file containing your code
The folder location - Where the script lives in the repository
The menu entry - The entry in Menu.ps1 that makes the script appear in the launcher
